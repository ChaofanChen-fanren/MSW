...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Train Filo",  add_help=True)
    parser.add_argument(
        "--clip_model",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default="openai",
        help="pretrained clip model wight path"
    )
    parser.add_argument(
        "--feature_list",
        type=int,
        nargs="+",
        default=[6, 12, 18, 24],
        help="clip model visual features used",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="./checkpoints/",
        help="path to save checkpoints weights",
    )
    ...
    for epoch in range(epochs):
        ...
        for items in tqdm(train_dataloader):
            ...
            for num in range(len(anomaly_maps)):
                loss += losses_focal(anomaly_maps[num], gt)
